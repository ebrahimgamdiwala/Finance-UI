...
const SUGGESTED_PROMPTS = [
  "Show me recent financial trends",
  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      const aiMessage = {
        ...
        role: "assistant",
        content: "I understand you're interested in that topic. Let me analyze the data and provide you with detailed insights. Based on recent financial trends, I can help you make informed decisions about your investments and spending patterns.",
        timestamp: new Date().toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })
      };
      ...
      <div className="w-full max-w-5xl relative z-10">
        ...
        <div className="mb-6 text-center animate-fade-in">
          <div className="flex items-center justify-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground ivy-font">FinanceBot</h1>
              <p className="text-sm text-emerald-500 ivy-font">AI Financial Data Analyst</p>
            </div>
          </div>
          <p className="text-muted-foreground ivy-font max-w-2xl mx-auto">
            Ask me about financial trends, analyze spending patterns, or get insights with visualizations
          </p>
        </div>
              ...
              <div className="flex gap-3 items-end">
                <div className="flex-1 relative">
                  <Textarea
                    ...
                    placeholder="Ask me about financial trends, spending patterns, or investment data..."
        ...
        <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
          {[
            { icon: TrendingUp, label: "Market Trends", value: "Active" },
            { icon: BarChart3, label: "Data Analysis", value: "Ready" },
            { icon: DollarSign, label: "Portfolio Sync", value: "Live" },
            { icon: PieChart, label: "Insights", value: "Updated" }
          ].map((stat, idx) => (
            <Card
              key={idx}
